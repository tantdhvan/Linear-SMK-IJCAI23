...
#set yrange [y1:y2]
set ytics ('0.01M' 9.2103,'0.5M' 13.12236,'1M' 16.1181)
...
plot "out1.csv" using 1:4 linestyle 1 title 'ALG1',"out1.csv" using 1:8 linestyle 2 title 'ALG2',"out1.csv" using 1:20 linestyle 3 title 'ALG3',"out1.csv" using 1:32 linestyle 4 title 'SMKDET',"out1.csv" using 1:44 linestyle 5 title 'SMKRAN',"out1.csv" using 1:48 linestyle 6 title 'SMKSTREAM'
