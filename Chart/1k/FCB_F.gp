...
#set yrange [y1:y2]
set ytics ('2K' 200000,'3K' 300000,'4K' 400000, '5K' 500000)
...
plot "out1.csv" using 1:7 linestyle 2 title 'ALG2',\
	"out1.csv" using 1:19 linestyle 3 title 'ALG3',\
	"out1.csv" using 1:43 linestyle 5 title 'SMKRAN',\
	"out1.csv" using 1:47 linestyle 6 title 'SMKSTREAM'
