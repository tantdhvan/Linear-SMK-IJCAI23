...
#set yrange [y1:y2]
set ytics ('0.1M' 11.512,'0.5M' 13.122,'1M' 13.815)

set xlabel 'B' font 'Arial-Bold, 20' offset 0,1 
set ylabel 'Number of queries' font 'Arial-Bold, 18' offset 1,0

set key horiz
set key left top font ",11"
plot "out1.csv" using 1:8 linestyle 2 title 'ALG2',\
	"out1.csv" using 1:20 linestyle 3 title 'ALG3',\
	"out1.csv" using 1:44 linestyle 5 title 'SMKRAN',\
	"out1.csv" using 1:48 linestyle 6 title 'SMKSTREAM'
